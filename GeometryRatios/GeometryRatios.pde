...
void draw() {
  ...
  fill(#000000);  // Set fill to black
  ellipse(faceX, faceY, faceDiameter, faceDiameter);  // Draw white ellipse using RADIUS mode
  ellipseMode(CENTER);  // Set ellipseMode to CENTER
  fill(#ffffff);  // Set fill to transparent
  ellipse(faceX, faceY, faceDiameter, faceDiameter);  // Draw gray ellipse using CENTER mode
